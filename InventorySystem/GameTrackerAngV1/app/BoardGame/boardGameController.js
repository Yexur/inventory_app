...
app.controller('boardGameController',
    ["$scope", "dataService", "cacheService", "$modal",
        function boardGameController($scope, dataService, cacheService, $modal) {

            $scope.title = "Board Games";
            ...
            $scope.getPurchasedBoardGamesByCategory = function (category) {
                // keep this around for later use in the save and edit functions
                $scope.categoryType = category.categoryType;
                dataService.getPurchasedBoardGamesByCategoryId(category.categoryId).then(
                    function (results) {
            ...
            $scope.gridOptions = {
                ...
                columnDefs: [{ field: 'description', displayName: 'Title', enableCellEdit: false, width: 250 },
                             ...
                             { field: 'designer', displayName: 'Designer', enableCellEdit: false, width: 175  },
                             { field: 'publisher', displayName: 'Publisher', enableCellEdit: false, width: 175 },
                             { field: 'numberOfPlayers', displayName: 'No. of Players', enableCellEdit: false, width: 150 },
                             { field: 'playingTime', displayName: 'Playing Time', enableCellEdit: false, width: 150  },
                             { field: 'boardGameId', visible: false },
